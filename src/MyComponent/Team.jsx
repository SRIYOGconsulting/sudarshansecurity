            ...
            <div key={member.id} className="text-center group">
              ...
              <div className="mb-6">
                <img 
                  src={member.img} 
                  alt={member.name}
                  className="w-48 h-48 mx-auto rounded-full object-cover border-4 border-green-100 group-hover:border-green-300 transition-all duration-300 shadow-lg group-hover:shadow-xl"
                />
              </div>
