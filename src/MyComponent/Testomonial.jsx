...
export default function Testimonial() {
  ...
  // Duplicate 3 times for smooth infinite drag
  ...
  useEffect(() => {
    ...
    const middle = carousel.scrollWidth / 3;
      ...
      <div className="max-w-6xl mx-auto px-4">
       <div className='mx-auto text-center px-4 py-4'>       
            <h1 className='text-green-800 italic font-bold  text-2xl'>Feedback</h1>
                <h2 className='text-4xl font-bold italic text-black '>What they're talking about sss</h2>
                </div>
  ...
  <div
    key={index}
    className="flex-shrink-0 w-full sm:w-1/2 px-2 sm:px-3 flex justify-center "
  >
    <div className="relative text-center max-w-md w-full py-6 ">
      ...
      {/* Card */}
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg pt-14 min-h-[380px] border-2 border-red-50">
