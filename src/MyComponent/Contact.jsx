...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#faf5e9] flex flex-col items-center px-8 pt-20 mt-16">
      <h2 className="text-2xl md:text-3xl italic text-teal-700 mb-10 font-bold ">
      ...
      <div className="w-full ">
        ...
        <div className="w-full ">
          <h3 className="text-xl font-bold text-teal-700 mb-4 text-center">
            Find Us Here
          </h3>
